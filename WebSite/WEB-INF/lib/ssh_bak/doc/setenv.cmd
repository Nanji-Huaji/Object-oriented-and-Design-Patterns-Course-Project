...
set CLASSPATH=%WEB_LIB%\mysql-connector-java-5.1.48.jar;%CLASSPATH%
...
set CLASSPATH=%WEB_LIB%\spring-aop-5.2.0.RELEASE.jar;%WEB_LIB%\spring-aspects-5.2.0.RELEASE.jar;%WEB_LIB%\spring-beans-5.2.0.RELEASE.jar;%WEB_LIB%\spring-context-5.2.0.RELEASE.jar;%WEB_LIB%\spring-context-indexer-5.2.0.RELEASE.jar;%WEB_LIB%\spring-context-support-5.2.0.RELEASE.jar;%WEB_LIB%\spring-core-5.2.0.RELEASE.jar;%WEB_LIB%\spring-expression-5.2.0.RELEASE.jar;%WEB_LIB%\spring-instrument-5.2.0.RELEASE.jar;%WEB_LIB%\spring-jcl-5.2.0.RELEASE.jar;%WEB_LIB%\spring-jdbc-5.2.0.RELEASE.jar;%WEB_LIB%\spring-jms-5.2.0.RELEASE.jar;%WEB_LIB%\spring-messaging-5.2.0.RELEASE.jar;%WEB_LIB%\spring-orm-5.2.0.RELEASE.jar;%WEB_LIB%\spring-oxm-5.2.0.RELEASE.jar;%WEB_LIB%\spring-test-5.2.0.RELEASE.jar;%WEB_LIB%\spring-tx-5.2.0.RELEASE.jar;%WEB_LIB%\spring-web-5.2.0.RELEASE.jar;%WEB_LIB%\spring-webflux-5.2.0.RELEASE.jar;%WEB_LIB%\spring-webmvc-5.2.0.RELEASE.jar;%WEB_LIB%\spring-websocket-5.2.0.RELEASE.jar;%CLASSPATH%
set CLASSPATH=%WEB_LIB%\aspectjrt-1.9.5.jar;%WEB_LIB%\aspectjweaver-1.9.5.jar;%CLASSPATH%